...
```
cd existing_repo
git remote add origin https://gitlab.com/dmrlobo/approximate_ecc.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/dmrlobo/approximate_ecc/-/settings/integrations)
...
Example:
```bash
python3 demo.py --viz --viz-dir dag_viz --viz-prefix dag --bit-length 40 --hash-bits 16 --row-group-size 2 --col-group-size 2 --flip-count 2 --seed 1
```
